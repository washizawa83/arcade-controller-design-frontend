...
export const DEFAULT_BUTTONS: ButtonInit[] = [
  { id: "GPIO02", name: "UP", x: 150, y: 142.5, d: 30 },
  { id: "GPIO04", name: "RIGHT", x: 134.34, y: 81.4, d: 30 },
  { id: "GPIO03", name: "DOWN", x: 105.94, y: 68.5, d: 30 },
  { id: "GPIO05", name: "LEFT", x: 74.08, y: 68.6, d: 30 },
  { id: "GPIO10", name: "P1", x: 164.7, y: 71.6, d: 30 },
  { id: "GPIO11", name: "P2", x: 193.6, y: 59.8, d: 30 },
  { id: "GPIO12", name: "P3", x: 225.7, y: 59.8, d: 30 },
  { id: "GPIO13", name: "P4", x: 257.6, y: 63.6, d: 30 },
  { id: "GPIO06", name: "K1", x: 162.1, y: 103.2, d: 30 },
  { id: "GPIO07", name: "K2", x: 192.3, y: 92.2, d: 30 },
  { id: "GPIO08", name: "K3", x: 225.8, y: 92, d: 30 },
  { id: "GPIO09", name: "K4", x: 257.7, y: 97, d: 30 },
  { id: "GPIO18", name: "LS", x: 117.6, y: 135, d: 30 },
  { id: "GPIO19", name: "RS", x: 182.4, y: 135, d: 30 },
  { id: "GPIO21", name: "A2", x: 41.46, y: 75, d: 30 },
  { id: "GPIO20", name: "A1", x: 214.8, y: 20, d: 18 },
  { id: "GPIO17", name: "START", x: 242.88, y: 20, d: 18 },
