...
export const BaseFooter = () => {
  return (
    <footer className="w-screen border-t border-slate-200 bg-white text-slate-700">
      <div className="mx-auto w-11/12 2xl:w-[1280px] py-8">
        <div className="flex flex-col md:flex-row md:items-start md:justify-between gap-6">
          <div className="max-w-xl text-sm leading-6">
            <p className="font-semibold text-slate-900">ご利用にあたって</p>
            <p className="mt-2">
          ...
          <nav className="text-sm">
            <p className="font-semibold text-slate-900">ポリシー</p>
